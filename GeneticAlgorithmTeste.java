        ...
        try {
            ...
            Fitness fitness = new Fitness() {
                ...
                public double fitness(String chromosome) {
                    ...
                    final int ideal_sum = 54;
                    final int ideal_prod = 1;
            ...
            String res = GeneticAlgorithm.findResult(100, list.length, fitness, p_c, p_m);
            System.out.println("\nres = " + res);


            res = GeneticAlgorithm.findResult(1500, kilos.length, fitness2, p_c, p_m);
            System.out.println("\nres = " + res);
