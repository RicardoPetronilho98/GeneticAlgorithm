    ...
    */
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            res = BinaryGeneticAlgorithm.findResult(500, list.length, fitness, p_c, p_m);
            System.out.println("\nres = " + res);
            ...
            System.out.println(chromosome_sum == ideal_sum && chromosome_prod == ideal_prod);

            res = BinaryGeneticAlgorithm.findResult(1000, kilos.length, fitness2, p_c, p_m);
            System.out.println("\nres = " + res);
